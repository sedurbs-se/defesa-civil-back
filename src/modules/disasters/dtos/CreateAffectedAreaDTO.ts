...
export abstract class CreateAffectedAreaDTO {
  @ApiPropertyOptional({
    description: "O id da área, caso não seja informado, será gerado um novo id."
  })
  @IsOptional()
  id?: string;
  ...
  @ApiProperty({
    description: "A ordem da área, consiste em um número inteiro que gerará uma sequência nas unidades habitacionais"
  })
